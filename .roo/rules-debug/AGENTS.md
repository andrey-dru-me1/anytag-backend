...
- **DATABASE_URL is auto-constructed** from `POSTGRES_USER`, `POSTGRES_PASSWORD`, `POSTGRES_DB`, `DB_PORT` in the Nix shellHook — if one of these is missing, `DATABASE_URL` won't be set and connections will fail silently
